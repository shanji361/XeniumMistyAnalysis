...
#below is part of the 10.1-10.7 xenium tutorial:
...
run_misty(com_path_act_views, "results/xenium_lung/com_path_act")

misty_results_com_path_act <- collect_results("results/xenium_lung/com_path_act/")
...
run_misty(com_path_act_views, "results/xenium_lung/com_path_act_linear", model.function = linear_model, bypass.intra = TRUE)

misty_results_com_path_act_linear <- collect_results("results/xenium_lung/com_path_act_linear")
